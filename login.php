...
<section class="login mt-5">
    <div class="container">
        <div class="card pt-1 p-1 d-flex flex-row justify-content-center col-lg-12">
            ...
            <form method="post" action="handle/login.php" class="col-lg-6 card-header card-footer d-flex flex-column card-header-tabs text-center justify-content-center ">
